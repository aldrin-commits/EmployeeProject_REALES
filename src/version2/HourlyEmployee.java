...
public class HourlyEmployee {
    ...
    public void displayHourlyEmployee() {
        System.out.printf(
                "ID: %d | Name: %s | Date Hired: %s | Birth Date: %s | Hours: %.2f | Rate: P%.2f/hr%n",
    ...
    public String toString() {
        return String.format(
                "HourlyEmployee [ID: %d, Name: %s, Date Hired: %s, Birth Date: %s, Hours: %.2f, Rate: P%.2f, Total Salary: P%.2f]",
                empID, empName, dateHired, birthDate,
